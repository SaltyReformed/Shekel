...
class TestDelete:
    ...
    def test_a_rule_less_definitions_row_is_hard_deleted(
        self, app, auth_client, seed_user, seed_periods_today,
    ):
        """The row goes; nothing regenerates it, so no tombstone is kept."""
        with app.app_context():
            ...
            # The definition stands until the doors leaf deletes the pair
            # together (R-BAL23); what this step decides is the ROW's arm.
