...
**144 steps, 107 open.** The dependency graph holds 92 edges over 61 rows.
...
| balance | E2-n | -- | Make the move and delete the registry, with `_FENCED_MODULE_RULINGS` as the LAST commit rather than the first. Its decomposition is decided from #73's trace. | #75 | -- | NOW |
