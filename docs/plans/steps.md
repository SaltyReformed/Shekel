...
**152 steps, 110 open.** The dependency graph holds 98 edges over 64 rows.
...
| pay_calendar | C2-f2d-4 | -- | Solve both gap levers against the assumptions the page is SHOWING, so a what-if slider moves the lever card with the verdict above it instead of leaving it solved at the stored settings. **MOVES DISPLAYED MONEY.** Closes **P59**. | #13 | -- | NOW / pay_calendar:C2-f2d-2 (shipped) |
