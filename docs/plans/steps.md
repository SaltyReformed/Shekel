...
| arc | id | also | what this step does | order | commit | starts |
|---|---|---|---|---|---|---|
| recurrence | R-F16 | -- | "How often am I paid" stopped having two stored answers: `salary_profiles.pay_periods_per_year` dropped, the paycheck engine takes a `PayrollBasis` binding a profile to its owner's cadence, and the investment path's employer-match basis stopped being raise-BLIND. Closed **F-16**; opened **D43**, **D44**. | SHIPPED | `4258ce28` | -- |
