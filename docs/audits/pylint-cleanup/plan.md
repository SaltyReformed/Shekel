...
`duplicate-code` (R0801) clusters, zero `useless-suppression`, zero E/F; 101 visible messages.
Full suite 5771 passed.** Phase 3 (design smells) has THIRTY-THREE files plus the form-mutation helper
family complete. The newest, **`services/tax_calculator.py` DONE** (`2cdde52`), cleared BOTH smells on
...
Next by live density (re-measured 2026-06-07 after **`services/tax_calculator.py` DONE** `2cdde52`; 12
smell items remain [7 of the 8-symbol set + 5 `too-many-instance-attributes`], down from 14).
