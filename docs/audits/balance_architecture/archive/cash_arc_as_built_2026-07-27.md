...
so that ledger carries only unresolved work. **Ten at the 2026-07-27 extraction, and four more the
same day**: X-g4b (`17c57cde`) shipped before its rows were re-pointed, and N-43 / N-46 / N-78 /
