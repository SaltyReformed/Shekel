...
so that ledger carries only unresolved work. **Ten at the 2026-07-27 extraction, and ten more the
same day** -- the four X-g4b left stale plus the six the X-q cluster closed (B-16, N-98, N-99,
N-101, then N-100 and N-102 at X-q2). X-g4b (`17c57cde`) shipped before its rows were re-pointed, and N-43 / N-46 / N-78 /
