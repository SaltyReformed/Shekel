...
Single authoritative implementation of the checking-anchor true-up
mutation.  The two HTMX anchor-edit endpoints (``inline_anchor_update``
from the accounts list and ``true_up`` from the grid) share an
