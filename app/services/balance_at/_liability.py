...
**The ONE sign flip is not here.**  :func:`app.services.liability_sign.owed`
(what an account owes is minus the balance it holds; ruling R-CC29's flip)
lived in this module from plan step credit_card:CC-5-5a (ruling R-CC47) until
CC-5-5b moved it out: the balance DOORS became its callers, and this module
imports the configured-loan arms that will read the flip at CC-5-5c, so
