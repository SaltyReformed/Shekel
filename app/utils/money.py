"""Centralized monetary rounding boundary (E-26, HIGH-04).
...
This module exposes exactly two helpers. ``round_money`` is the default
boundary rounding. ``round_money_ceiling`` is the explicitly-named
sanctioned variant for the savings-goal monthly contribution case, where
under-funding by a fraction of a cent must never round down -- naming the
